  ...
  try {
    ...
    if (evidenceFlag || persistentFlag) {
      ...
      const allNodes: Array<import('@/lib/news/semantic-graph').SystemNode> = [
        ...
        'LABOR_CONSTRAINT','CAPITAL_CONSTRAINT','CYBERSECURITY_INFRA',
        'AI_SOFTWARE','ROBOTICS_AUTOMATION','QUANTUM_COMPUTING','BIOTECH_GENOMICS',
        'HEALTHCARE_MEDTECH','BATTERY_STORAGE','HYDROGEN_FUELCELL','AUTONOMOUS_MOBILITY',
        'CLIMATE_CARBON','WATER_INFRA','DIGITAL_ASSETS','ADVANCED_MATERIALS',
      ];
