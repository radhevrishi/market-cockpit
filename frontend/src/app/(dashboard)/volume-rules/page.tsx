...
const RULES: Rule[] = [
  ...
  // 🎯 ENTRIES
  // ═══════════════════════════════════════════════════════════════════════
  // ── CHEAT ENTRIES — Minervini's pre-pivot library ──
  // Cheats are early entries INSIDE the base, BEFORE the proper O'Neil pivot
  // breaks. Pivot of a cheat = the high of a tight consolidation shelf that
  // forms partway through the base structure. Risk-reward is asymmetric:
  // smaller stop (5-7%) and earlier entry, but requires the rest of the base
  // to play out. Used by Minervini for SEPA-style entries on the highest-RS
  // names — gets in 5-15% earlier than the proper pivot, frees you from
  // chasing on the breakout day.
  {
    id: 'low-cheat',
    title: 'Low Cheat (1st Cheat in the Base)',
    emoji: '🔓',
    oneliner: 'Earliest cheat — formed in the lower third of the base, highest reward, lowest probability.',
    timeframe: 'W',
    source: 'Minervini (SEPA)',
    color: 'saffron',
    section: 'entries',
    conditions: [
      'Stock has been declining, prints a low, then begins to base. Base structure forming for 4-8 weeks.',
      'Right side has bounced 5-15% off the absolute low — NOT yet near the middle of the base.',
      'A tight 1-2 week horizontal range forms — the "low cheat shelf". Weekly range < 6%.',
      'Volume dries up in the shelf, then expands on the breakout above the shelf high.',
      'Stop: 5-7% below entry OR below the shelf low (whichever is tighter).',
    ],
    fakeouts: [
      { label: 'Stage 4 trap', detail: 'A "low cheat" inside a Stage 4 downtrend is a dead-cat-bounce setup. The base structure hasn\'t actually formed. 30W MA must be flat or starting to inflect up — never falling.' },
      { label: 'No real shelf', detail: 'A 2-3 day pause is not a shelf. Demand 1-2 weeks of tight closes (under 6% range). Anything shorter is randomness.' },
      { label: 'Volume not drying', detail: 'If volume stays elevated in the "shelf", supply hasn\'t been absorbed. The breakout will fail. Volume contraction is the whole point.' },
    ],
    visual: 'On the chart, a small horizontal pause forming just above the base low. Looks like a tiny shelf in the early-stage base. Volume bars contract through the shelf, expand on the break.',
    illustration: '\\          ____ low cheat pivot\n \\        /\n  \\______/\n   shelf (1-2W tight)\n___________  base low',
  },
  {
    id: 'mid-cheat',
    title: 'Mid Cheat (2nd Cheat in the Base)',
    emoji: '🔓',
    oneliner: 'Middle-of-base cheat — better probability than Low Cheat, still earlier than the proper pivot.',
    timeframe: 'W',
    source: 'Minervini (SEPA)',
    color: 'saffron',
    section: 'entries',
    conditions: [
      'Base / cup is 30-60% complete. Right side has advanced to within roughly the middle of the cup depth.',
      'A 2-3 week horizontal shelf forms in the middle band of the base.',
      'Weekly ranges in the shelf are tight (< 5%) and successively narrower than the prior shelf.',
      'Volume contracts through the shelf to less than 0.8× of 20-week average.',
      'Entry: weekly close above shelf high on volume ≥ 1.5× of 20-week average.',
      'Stop: just below the shelf low (typically 5-6% below entry).',
    ],
    fakeouts: [
      { label: 'Premature shelf', detail: 'The mid-cup needs the right side to actually advance to the middle. A "shelf" at 20% of base depth is still in Low Cheat territory. Don\'t confuse the two.' },
      { label: 'No volume expansion', detail: 'Breakout above shelf high on volume < 1.5× average is a low-conviction print. Wait for the proper pivot or a clearer signal.' },
      { label: '30W still falling', detail: 'Mid-cheats fail systematically when the 30W MA is still falling. Demand the trend transition — flat or rising MAs only.' },
    ],
    visual: 'On the weekly chart, the cup is forming and the right side has climbed to about the midpoint. A 2-3 week sideways drift forms a clear shelf. Volume dies. Breakout = entry.',
    illustration: '         ___      ___\n        /   \\____/   \\  ← mid cheat shelf (50% up)\n       /              ^pivot\n      /\n_____/  cup low',
  },
  {
    id: 'high-cheat',
    title: 'High Cheat / Cup Cheat Line',
    emoji: '📏',
    oneliner: 'Highest-probability cheat — shelf forms 5-15% below the cup high. The "cup cheat line" is the shelf high.',
    timeframe: 'W',
    source: 'Minervini (SEPA)',
    color: 'green',
    section: 'entries',
    conditions: [
      'Cup is 70-90% complete. Right side has advanced to within 5-15% of the prior cup high.',
      'A tight 1-3 week horizontal shelf forms BELOW the cup high. This shelf high is the "cup cheat line".',
      'Cup cheat line is drawn as a horizontal line at the shelf resistance.',
      'Volume contracts hard through the shelf — to 0.7-0.85× of 20-week average (significant dry-up).',
      'Entry: weekly close above the cup cheat line on volume ≥ 2.0× of 20-week average.',
      'Stop: just below the cup cheat line — typically 4-6% below entry.',
    ],
    fakeouts: [
      { label: 'Wide shelf range', detail: 'A "shelf" spanning >10% range isn\'t a shelf — it\'s a base within a base. Wait for true tightness (< 5% range over 2-3 weeks).' },
      { label: 'Multiple cheat lines', detail: 'If you see 3 different horizontal lines all claiming to be the "cup cheat line", the shelf isn\'t tight enough. Demand a single clean horizontal resistance.' },
      { label: 'Bullish exhaustion', detail: 'A high cheat at the cup high after a 100%+ run in the prior year is exhaustion, not a continuation cheat. Apply more carefully on already-extended names.' },
    ],
    visual: 'On the weekly chart, the cup is nearly complete. Just below the cup high, draw a horizontal line at the resistance where price has been pausing. That line IS the cup cheat line. Volume dries up dramatically in the shelf. Break of the line + heavy volume = entry.',
    illustration: '    cup high ____.......\n              ────────  ← cup cheat line\n       _______/      ↑ pivot\n      /             tight shelf\n     /              (1-3 weeks)\n____/  base low',
  },
  {
    id: 'handle-cheat',
    title: 'Handle Cheat / Handle Cheat Line',
    emoji: '🔧',
    oneliner: 'Inside the handle of cup-with-handle — enter BEFORE the proper handle-high break.',
    timeframe: 'W',
    source: 'Minervini (SEPA)',
    color: 'green',
    section: 'entries',
    conditions: [
      'Cup-with-handle is forming — cup phase complete, handle has formed for 1-2 weeks of drift down (8-12% depth).',
      'In the FINAL 2-5 trading days of the handle, price tightens further — daily range < 2% per session.',
      'A horizontal line at the recent handle resistance = "handle cheat line".',
      'Volume reaches ultra-low ("VDU" — volume dry-up). Daily volume < 0.7× of 50-day average.',
      'Entry: intraday break above the handle cheat line — before the proper handle high pivot at handle high + 10 paise.',
      'Stop: just below the handle cheat line (~3-5% below entry, very tight).',
    ],
    fakeouts: [
      { label: 'No VDU in the handle', detail: 'A handle without volume dry-up is incomplete supply absorption. Wait for the final 2-3 days of ultra-low volume before triggering.' },
      { label: 'Handle in lower half', detail: 'A handle that forms in the lower half of the cup is a disqualifier per O\'Neil. Don\'t cheat-enter a broken cup.' },
      { label: 'Handle too long', detail: 'A "handle" stretching 4+ weeks isn\'t a handle — it\'s a separate consolidation. The handle cheat doesn\'t apply.' },
    ],
    visual: 'On the daily chart, the handle is drifting down on declining volume. In the last 2-5 days, price stops dropping and forms tight daily candles right at a horizontal resistance. Volume is the lowest of the entire base. Break of that resistance = handle cheat entry.',
    illustration: '       ____         <- cup high\n      /    \\___\n     /         \\  ← handle (1-2W)\n    /           |____ ← handle cheat line\n   /            |    ↑ entry on break\n  /             (final tight 2-5 days)\n_/  cup low',
  },
  {
    id: 'vcp-cheat',
    title: 'VCP Cheat (Pre-Final Contraction Entry)',
    emoji: '🎯',
    oneliner: 'Enter on the breakout of an interim VCP contraction — not the final.',
    timeframe: 'W',
    source: 'Minervini (SEPA)',
    color: 'saffron',
    section: 'entries',
    conditions: [
      'VCP base with 3+ contractions has formed.',
      'You skip the proper pivot (final contraction high) and instead enter on the breakout of an EARLIER contraction.',
      'Best variant: enter on breakout of contraction #3 (when total VCP is 3T or 4T).',
      'That contraction high acts as the cheat pivot. Volume must expand to ≥ 1.5× of 20W average on the break.',
      'Stop: just below the contraction low. Typically 4-6% below entry.',
    ],
    fakeouts: [
      { label: 'Contractions not tightening', detail: 'If contractions aren\'t actually getting tighter, it\'s not a VCP. Demand sequential narrowing: 25% → 12% → 6% etc.' },
      { label: 'Volume rising into pivot', detail: 'VCP demands volume DRYING as contractions tighten. Volume rising = supply building, not absorbing.' },
      { label: 'Too early in the sequence', detail: 'Entering on contraction #1 or #2 is gambling — the structure hasn\'t fully formed. Wait for at least 2 prior contractions before triggering.' },
    ],
    visual: 'A weekly chart showing the wedge-like compression of a VCP. Mark the high of each contraction with a horizontal line. The cheat entry is the breakout of contraction #3 of #4 — earlier than the proper pivot at the final tight high.',
    illustration: '|\\\n| \\  /\\\n|  \\/  \\___ ← contraction 3 high = cheat pivot\n      \\ /\\___\n       /   \\___ ← final = proper pivot\n      25% 12% 6% 3%',
  },
  {
    id: 'pocket-pivot-cheat',
    title: 'Pocket Pivot as Cheat Entry',
    emoji: '🔹',
    oneliner: 'Use a pocket-pivot day as the earliest institutional footprint — cheat in before the proper pivot.',
    timeframe: 'D',
    source: 'Morales/Kacher',
    color: 'green',
    section: 'entries',
    conditions: [
      'Stock is inside a constructive base (low / mid / high — any stage).',
      'A pocket-pivot day prints: up-day volume > the HIGHEST down-day volume in the prior 10 trading days.',
      'Price closes above the 10-day MA (and ideally the 50-day MA) on the pocket pivot day.',
      'Entry: end-of-day on the pocket pivot, OR the day after if price holds within 1% of the pocket pivot close.',
      'Stop: below the pocket pivot day low — typically 5-7% below entry.',
    ],
    fakeouts: [
      { label: 'Pocket pivot below 10-DMA', detail: 'A pocket-pivot-shaped volume bar with the close below the 10-day MA is a dead-cat bounce. Volume signature without trend respect = noise.' },
      { label: 'News-driven pocket', detail: 'The up-volume bar is an earnings-day or news-day spike. Single events don\'t mean institutional accumulation. Wait for follow-through.' },
      { label: 'After a vertical run', detail: 'Pocket pivots in already-extended stocks become less predictive. The footprint works inside a forming base, not after the move is mature.' },
    ],
    visual: 'On the daily chart, color the up-volume days green, down-volume days red. The pocket pivot day\'s green bar towers over every red bar in the prior 10 days. That\'s the institutional footprint — enter same day or next.',
    illustration: 'red red red GREEN← red green ← pocket pivot\n         (up-vol > max down-vol of prior 10D)',
  },
  {
    id: 'reversal-recovery-cheat',
    title: 'Reversal Recovery Cheat',
    emoji: '↩',
    oneliner: 'V-shaped recovery from a brief plunge inside the base — enter on the reclaim.',
    timeframe: 'D+W',
    source: 'Minervini (SEPA)',
    color: 'saffron',
    section: 'entries',
    conditions: [
      'Stock is inside a base. Suddenly pierces a key support (50-day MA, prior pivot, or base low).',
      'Recovers SHARPLY — closes back above that support within 1-3 sessions.',
      'Volume on the recovery day is heavy (≥ 1.5× of 50-day average).',
      'Range of the recovery day spans 70%+ of the prior down-move.',
      'Entry: end-of-day on the recovery confirmation. Stop: below the recovery low (very tight, 3-5%).',
    ],
    fakeouts: [
      { label: 'Light-volume reclaim', detail: 'The recovery is a relief bounce, not commitment. Without heavy volume on the reclaim, the second test usually fails.' },
      { label: 'Multiple tests needed', detail: 'A "reversal" that takes 5+ sessions to reclaim is a re-test, not a V-recovery. Lower probability than a 1-3 day reclaim.' },
    ...
    visual: 'A sharp red day or two pierces support. Then a sharp green day on heavy volume closes ABOVE the support level. The two days together form a "V" in the chart. Entry on the close above support.',
    illustration: '\\        /\n \\      /\n  \\    /  <- recovery day (≥ 1.5× volume)\n   \\  /\n    \\/  <- pierced support (intraday low)\n   support  ← stop: just below recovery low',
  },
  {
    id: 'squat-cheat',
    title: 'Squat Cheat (Minervini Squat)',
    emoji: '🦘',
    oneliner: 'Sharp 1-3 day dip inside the base shakes out weak hands — enter on the recovery.',
    timeframe: 'D',
    source: 'Minervini (SEPA)',
    color: 'amber',
    section: 'entries',
    conditions: [
      'Stock is inside a base (not yet broken out).',
      '1-3 session sharp drop, 5-10% magnitude — the "squat".',
      'Volume spikes on the squat (panic selling getting absorbed).',
      'Recovery: stock reclaims the pre-squat range within 5 sessions on dry volume.',
      'After the squat, the base resumes normal sideways character — structure is intact.',
      'Entry: end-of-day on the recovery confirmation. Stop: below the squat low (5-7%).',
    ],
    fakeouts: [
      { label: 'Squat that doesn\'t recover', detail: 'A 7% drop that does NOT reclaim within 5 sessions isn\'t a squat — it\'s the base breaking. Pattern void.' },
      { label: 'Squat in extended stock', detail: 'A "squat" 30 weeks into a parabolic move is the start of distribution, not a shakeout.' },
      { label: 'Squat into news', detail: 'A 7% drop on news doesn\'t reset the base — it changes the thesis. Re-evaluate fundamentals first.' },
    ],
    visual: 'A single deep red candle on heavy volume sticking out below the otherwise tight base. Then a quick recovery green day reclaims the prior range. Entry on the reclaim.',
    illustration: '── ── ── ── tight base ── ──\n           |\n           V     ← squat (1-3 days)\n           ___\n              \\__ ← reclaim & entry',
  },
  {
    id: 'htf-flag-cheat',
    title: 'High-Tight-Flag Cheat',
    emoji: '🚀',
    oneliner: 'Enter inside the flag of an HTF before the proper pivot break.',
    timeframe: 'W',
    source: 'Composite',
    color: 'green',
    section: 'entries',
    conditions: [
      'High-Tight Flag pattern is forming: prior 100%+ advance in 4-8 weeks, then flag consolidation begins.',
      'Inside the 3-5 week flag, a tight 1-2 week shelf forms BELOW the flag high.',
      'Shelf weekly range < 5%, volume dries to < 0.8× of 20-week average.',
      'Entry: weekly close above the shelf high. Volume ≥ 1.5× of 20-week average.',
      'Stop: just below the shelf low — typically 6-8% below entry (HTFs are inherently more volatile).',
    ],
    fakeouts: [
      { label: 'Flag too wide', detail: 'A "flag" wider than 25% is a regular correction, not an HTF flag. The cheat doesn\'t apply.' },
      { label: 'Pre-100% misread', detail: 'Without the 100%-in-8-weeks prior advance, what looks like an HTF flag is just a tight base. Apply standard rules instead.' },
      { label: 'Volume not contracting', detail: 'Volume rising through the flag = ongoing supply. HTF requires the flag to dry up dramatically. If not, structure is failing.' },
    ],
    visual: 'After a near-vertical advance, a tight rectangular consolidation forms — the flag. Inside the flag, a horizontal shelf forms near the top. Volume dries up. Break of the shelf high = cheat entry, before the proper pivot at the flag high.',
    illustration: '       _____\n      /     \\____ ← shelf inside flag\n     /          ↑ HTF cheat entry\n    /\n   /  flag forms here (3-5W tight)\n  /\n /  +100% in 4-8 weeks',
  },
  {
    id: 'power-buy',
    title: 'Power Buy',
