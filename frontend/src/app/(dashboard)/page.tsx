    ...
    <div style={{ minHeight: '100%', background: BG, color: TEXT, padding: '20px 24px' }}>
      <div style={{ maxWidth: 1400, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          <div>
            {/* zzz241 — greeting header removed per user request. Date + status chips remain below. */}
            <div style={{ marginTop: 0, fontSize: 12, color: DIM, display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap', rowGap: 6 }}>
...
function passesQualityPreset(b: any): boolean {
  ...
  // zzz659 — 60 -> 40, mirroring the US preset. PEAD is a drift proxy, not a
  // quality score: 35% of it is the one-day reaction, so a gate at 60 quietly
  // excluded every good quarter the market sold on the day. See US_PRESET.
  if (!(typeof b.pead_score === 'number' && b.pead_score >= 40)) return false;              // PEAD ≥ 40
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, marginTop: 12, alignItems: 'flex-start' }}>
          ...
          <div style={{ flex: '1.5 1 330px', minWidth: 0, background: 'linear-gradient(135deg, rgba(239,68,68,0.07), rgba(245,158,11,0.03) 60%, transparent)', border: '1px solid rgba(245,158,11,0.28)', borderRadius: 12, padding: '13px 15px' }}>
            ...
            <div style={{ fontSize: 10, color: DIM, marginTop: 3, lineHeight: 1.5 }}>
              Your full preset — <span style={{ color: 'var(--mc-text-3)' }}>Sales≥20 · EPS≥25 · PEAD≥40 · OPM Δ≥0 · CFO/PAT≥0.5 · ₹3k Cr+ · 0 pledge · BB/STRONG</span> — every gate strict, ranked by pullback, biggest dip first. Red = on sale; green = still near its high. Buy great earnings on the dip.
            </div>
            {pullbacks.length === 0 ? (
