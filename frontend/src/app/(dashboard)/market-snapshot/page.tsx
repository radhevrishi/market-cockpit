          ...
          return (
            <button
              ...
              style={{
                ...
                padding: '6px 12px',
                borderRadius: 8,
                border: isActive ? '1px solid color-mix(in srgb, var(--mc-accent) 38%, transparent)' : '1px solid var(--mc-bg-4)',
                backgroundColor: isActive ? 'color-mix(in srgb, var(--mc-accent) 13%, transparent)' : 'transparent',
