    ...
    <div style={{ padding: '24px', minHeight: 'calc(100vh - 80px)' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
        <div style={{
          ...
          border: '2px solid var(--mc-bg-4)',
          borderTopColor: 'var(--mc-cyan)',
          animation: 'mb-spin 0.9s linear infinite',
        }} />
        <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--mc-text-1)', letterSpacing: '0.5px' }}>
          📊 Multibagger Ranking
        </span>
      ...
      {/* Skeleton table */}
      <div style={{ border: '1px solid var(--mc-bg-4)', borderRadius: 8, overflow: 'hidden' }}>
