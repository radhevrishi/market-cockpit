...
const NAV: NavItem[] = [
  ...
  { href: '/forward-watch',     label: 'Forward Watch',  icon: <Compass className="w-5 h-5" /> },
  { href: '/capital-allocation', label: 'Capital Alloc.', icon: <Briefcase className="w-5 h-5" /> },
  { href: '/concall-intel',     label: 'Concall Intel',  icon: <Newspaper className="w-5 h-5" /> },
  { href: '/sector-cycles',     label: 'Sector Cycles',  icon: <RefreshCw className="w-5 h-5" /> },
