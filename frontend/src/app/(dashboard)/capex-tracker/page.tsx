      ...
      {tab === 'concallpro' && (
        <div style={padding:'14px 4px', maxWidth: 1180, margin: '0 auto'}>
          ...
          <div style={{display:'grid', gridTemplateColumns:'repeat(2, 1fr)', gap:8}}>
            <div style={padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}>
              <div style={{fontWeight:700, color:C.cyan, marginBottom:6}}>🏗 Capacity &amp; Capex</div>
              <span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>utilization</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>capex</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>commission</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>expansion</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>brownfield</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>greenfield</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>debottleneck</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>MW</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>MT</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>tonnes</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>kgs</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>installed</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>operational by</span>
            </div>
            <div style={padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}>
              <div style={{fontWeight:700, color:C.cyan, marginBottom:6}}>📦 Demand &amp; Pipeline</div>
              <span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>order book</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>backlog</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>pipeline</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>enquir</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>RFQ</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>RFP</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>tender</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>book-to-bill</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>marquee customer</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>design win</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>repeat order</span>
            </div>
            <div style={padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}>
              <div style={{fontWeight:700, color:C.cyan, marginBottom:6}}>💰 Margins &amp; Pricing</div>
              <span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>EBITDA margin</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>operating margin</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>gross margin</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>pricing</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>pricing power</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>pass-through</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>raw material</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>operating leverage</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>realization</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>mix</span>
            </div>
            <div style={padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}>
              <div style={{fontWeight:700, color:C.cyan, marginBottom:6}}>🔮 Guidance &amp; Outlook</div>
              <span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>guidance</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>expect</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>target</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>outlook</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>visibility</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>FY27</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>FY28</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>medium-term</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>steady state</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>structural</span>
            </div>
            <div style={padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}>
              <div style={{fontWeight:700, color:C.cyan, marginBottom:6}}>💸 Balance Sheet &amp; Funding</div>
              <span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>debt</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>net cash</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>D/E</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>QIP</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>fundraise</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>working capital</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>receivable days</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>inventory days</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>interest cost</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>contingent liability</span>
            </div>
            <div style={padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}>
              <div style={{fontWeight:700, color:C.cyan, marginBottom:6}}>🚩 Risks &amp; Red Flags</div>
              <span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>one-off</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>exceptional</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>deferred</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>delay</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>challenging</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>headwind</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>lumpy</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>provision</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>write-off</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>related party</span><span style={display:'inline-block', padding:'2px 8px', margin:'2px 4px 2px 0', background:'rgba(255,215,0,0.10)', border:`1px solid ${C.gold}`, borderRadius:10, fontSize:11, color:C.gold}>auditor</span>
            </div>
          </div>
          ...
          <div style={{display:'grid', gridTemplateColumns:'repeat(2, 1fr)', gap:8}}>
            <div style={padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}><b style={{color:C.green}}>Pharma / CDMO / API</b><br/><span style={fontSize:11, color:C.dim, fontStyle:'italic'}>tailwinds:</span> FDA approval · USFDA cleared · EUGMP · WHO-GMP · ANDA filings · DMF · China+1 · captive · backward-integration<br/><span style={fontSize:11, color:C.dim, fontStyle:'italic'}>red flags:</span> 483 · warning letter · import alert · OAI · recall · patent cliff · price erosion</div>
            <div style={padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}><b style={{color:C.green}}>Solar / Renewables</b><br/><span style={fontSize:11, color:C.dim, fontStyle:'italic'}>tailwinds:</span> PLI · ALMM · RPO · safeguard duty · BCD · order book MW · battery storage · domestic content<br/><span style={fontSize:11, color:C.dim, fontStyle:'italic'}>red flags:</span> China dumping · polysilicon spike · module price erosion · curtailment · DISCOM payments</div>
            <div style={padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}><b style={{color:C.green}}>T&amp;D / Power Equipment</b><br/><span style={fontSize:11, color:C.dim, fontStyle:'italic'}>tailwinds:</span> smart meter · RDSS · data center · transmission line · transformer · substation · battery storage<br/><span style={fontSize:11, color:C.dim, fontStyle:'italic'}>red flags:</span> DISCOM payment delay · subsidy backlog · execution slippage · L1 vs L1+5%</div>
            <div style={padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}><b style={{color:C.green}}>Capital Goods / Defense / Railways</b><br/><span style={fontSize:11, color:C.dim, fontStyle:'italic'}>tailwinds:</span> order book · book-to-bill · indigenization · Make in India · iDEX · Kavach · Vande Bharat · L1<br/><span style={fontSize:11, color:C.dim, fontStyle:'italic'}>red flags:</span> tender delay · L1 walk-away · provisioning · execution risk · cost over-run</div>
            <div style={padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}><b style={{color:C.green}}>Auto-Ancillary / EMS</b><br/><span style={fontSize:11, color:C.dim, fontStyle:'italic'}>tailwinds:</span> EV ramp · design win · premium model · OEM Tier-1 · content per vehicle · BOM enrichment<br/><span style={fontSize:11, color:C.dim, fontStyle:'italic'}>red flags:</span> customer concentration · OEM destocking · model phase-out · receivable stretch</div>
            <div style={padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}><b style={{color:C.green}}>Specialty Chem / Agrochem</b><br/><span style={fontSize:11, color:C.dim, fontStyle:'italic'}>tailwinds:</span> China+1 · destocking ended · inventory normalization · innovator partnership · multi-year contract<br/><span style={fontSize:11, color:C.dim, fontStyle:'italic'}>red flags:</span> inventory overhang · price erosion · oil-linked volatility · environmental fine</div>
            <div style={padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}><b style={{color:C.green}}>Food / FMCG / Egg</b><br/><span style={fontSize:11, color:C.dim, fontStyle:'italic'}>tailwinds:</span> feed cost down · EU import demand · premiumization · A&amp;P leverage · distribution expansion<br/><span style={fontSize:11, color:C.dim, fontStyle:'italic'}>red flags:</span> feed cost spike · FX weakness · channel destocking · ASP cut</div>
            <div style={padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}><b style={{color:C.green}}>Steel / Cement / Bulk Commodities</b><br/><span style={fontSize:11, color:C.dim, fontStyle:'italic'}>tailwinds:</span> utilization &gt;85% · price hike sustained · China discipline · iron-ore down<br/><span style={fontSize:11, color:C.dim, fontStyle:'italic'}>red flags:</span> China capacity restart · price collapse · spread compression · debt funded expansion</div>
          </div>
          ...
          <div style={{display:'grid', gridTemplateColumns:'repeat(3, 1fr)', gap:8}}>
            <div style={{...{padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}, borderColor:C.green}}>
            ...
            <div style={{...{padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}, borderColor:C.amber}}>
            ...
            <div style={{...{padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}, borderColor:C.red}}>
          ...
          <div style={padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}>
            ...
            <div style={{marginTop:6}}><b style={{color:C.cyan}}>Question quality rule:</b> note who asks. Long-only buy-side (e.g. Fidelity, T.Rowe, Prima, ICICI Pru AMC, HDFC AMC) ≠ small broker analyst. Buy-side questions usually probe thesis, not numbers.</div>
          ...
          <div style={padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}>
            <div><b style={{color:C.gold}}>Step 1 (10s):</b> press ctrl+F → search <b>"guidance"</b>. Read those 3-5 sentences.</div>
            <div style={{marginTop:4}}><b style={{color:C.gold}}>Step 2 (15s):</b> ctrl+F → <b>"order book"</b> or <b>"backlog"</b>. Note the number.</div>
            <div style={{marginTop:4}}><b style={{color:C.gold}}>Step 3 (15s):</b> ctrl+F → <b>"utilization"</b>. Note %. Compare to last call.</div>
            <div style={{marginTop:4}}><b style={{color:C.gold}}>Step 4 (10s):</b> ctrl+F → <b>"capex"</b>. Note total spend and timeline.</div>
            <div style={{marginTop:4}}><b style={{color:C.gold}}>Step 5 (10s):</b> ctrl+F → <b>"margin"</b>. Note direction + steady state.</div>
            <div style={{marginTop:8, ...{fontSize:11, color:C.dim, fontStyle:'italic'}}}>Five searches, one minute, 80% of the signal. The deep read can wait for the weekend.</div>
          </div>
          ...
          <div style={padding:10, background:'rgba(174,187,208,0.04)', border:`1px solid ${C.muted}`, borderRadius:6, marginBottom:8, fontSize:12, color:C.body, lineHeight:1.55}>
            <div><b style={{color:C.gold}}>1.</b> Write your <b>3-bullet thesis update</b>: confirmed / weakened / pivoted. One bullet each, max 15 words.</div>
            ...
            <div style={{marginTop:6, ...{fontSize:11, color:C.dim, fontStyle:'italic'}}}>The investors who compound are the ones who consistently close the loop. Concall = data. Action = wealth.</div>
          </div>
