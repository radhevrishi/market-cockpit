...
// Fetch NIFTY Smallcap 50
export async function fetchNiftySmallcap50() {
  return nseApiFetch('/api/equity-stockIndices?index=NIFTY%20SMLCAP%2050', 60000);
}

// Fetch NIFTY Smallcap 100
export async function fetchNiftySmallcap100() {
  return nseApiFetch('/api/equity-stockIndices?index=NIFTY%20SMLCAP%20100', 60000);
}
