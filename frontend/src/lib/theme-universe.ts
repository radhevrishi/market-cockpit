...
export const INDIA_THEMES: ThemeDef[] = [
  ...
  { id: 'in-defence',      name: 'Defence',             emoji: '🛡️', group: 'Capex & Strategic', proxy: '^NSE:DEFENCE', basket: ['HAL.NS','BEL.NS','BDL.NS','MAZDOCK.NS','SOLARINDS.NS','COCHINSHIP.NS'], note: 'Defence indigenisation leaders' },
  ...
  { id: 'in-power',        name: 'Power / T&D',         emoji: '⚡', group: 'Capex & Strategic', proxy: '^NSE:POWER', basket: ['POWERGRID.NS','CGPOWER.NS','SIEMENS.NS','ABB.NS','TRANSFORMER.NS'], note: 'Power gen + transmission & distribution' },
  ...
  { id: 'in-chemicals',    name: 'Chemicals',           emoji: '🧪', group: 'Energy & Materials', proxy: '^NSE:CHEMICALS', basket: ['SRF.NS','PIIND.NS','DEEPAKNTR.NS','NAVINFLUOR.NS','AARTIIND.NS'], note: 'Specialty chemicals (China+1)' },
  ...
  { id: 'in-newage',       name: 'New-age Internet',    emoji: '📱', group: 'Tech & New-Age', proxy: '^NSE:INTERNET', basket: ['PAYTM.NS','NYKAA.NS','POLICYBZR.NS','IRCTC.NS'], note: 'Consumer-internet platforms' },
  { id: 'in-hospitals',    name: 'Hospitals',           emoji: '🏥', group: 'Healthcare & Consumer', proxy: '^NSE:HOSPITALS', basket: ['APOLLOHOSP.NS','MAXHEALTH.NS','FORTIS.NS','NH.NS'], note: 'Hospital chains' },
  { id: 'in-cement',       name: 'Cement',              emoji: '🧱', group: 'Energy & Materials', proxy: '^NSE:CEMENT', basket: ['ULTRACEMCO.NS','SHREECEM.NS','AMBUJACEM.NS','ACC.NS'], note: 'Cement (housing + infra cycle)' },
