...
const RULES: ThemeRule[] = [
  {
    ...
    high: [
      /\bai\s+(infrastructure|compute|comput\w*|inference|training|workload)/i,
      /\bgpu\s+(scaling|cluster|compute|server|farm|accelerat|technology)/i,
      /\bnvidia\b/i,
      /\b(grace\s+hopper|h100|h200|b100|b200|blackwell|hopper|ampere|grace)\b/i,
      /\bgenerative\s+ai/i,
      /\baccelerated\s+comput\w*/i,
      ...
      /\bgraphical?\s+processing\s+unit/i,
      /\bgraphics\s+processing\s+unit/i,
      /\bartificial\s+intelligence\s+(workload|comput\w*|deploy\w*|infrastructure)/i,
    ],
    low: [
      /\bai\b/i,
  ...
  },
  {
    ...
    high: [
      /\bedge\s+(ai|compute|comput\w*|inference|deploy\w*)/i,
      /\brugged\s+(compute|comput\w*|server|laptop|edge|enclosure|chassis|module|hardware)/i,
      ...
      /\bedge\s+deployment/i,
      /\bhigh\s*-?\s*performance\s+comput\w*\s+(module|system|edge|deploy)/i,
    ],
    low: [
      /\bedge\b/i,
      /\brugged\b/i,
  ...
  },
  {
    ...
    high: [
      /\bhpc\b/i,
      /\bhigh\s*-?\s*performance\s+comput\w*/i,
      /\bgpu\s+(server|cluster|farm|node|module|technology)/i,
      /\bnvlink/i,
      /\binfiniband/i,
      /\bhbm\d?\b/i,
    ...
    low: [
      ...
      /\bsupercomputer/i,
      /\bdata\s+center/i,
      /\bcomput\w*\s+module/i,
      /\bcomput\w*\s+system/i,
    ],
  },
  {
