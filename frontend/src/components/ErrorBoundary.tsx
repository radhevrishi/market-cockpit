    ...
    if (this.state.hasError) {
      ...
      return (
        <div style={{
          ...
          <p style={{ fontSize: '15px', fontWeight: '700', color: 'var(--mc-text-0)', margin: '0 0 8px' }}>
            {this.props.context ? `${this.props.context} — ` : ''}Something went wrong
          </p>
          <p style={{ fontSize: '12px', color: 'var(--mc-text-4)', margin: '0 0 20px', maxWidth: '400px', lineHeight: '1.5' }}>
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            <button
              ...
              style={{
                ...
                backgroundColor: 'var(--mc-accent)', border: 'none', color: 'white',
