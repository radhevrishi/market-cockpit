...
BOTTLENECK_KEYWORDS = {
    ...
    "INDIA_POWER_GRID": [
        ...
        # Expanded: thermal, hydro, gas-based power
        "ntpc shutdown", "ntpc capacity", "thermal power plant delay",
        "coal india supply", "coal india production", "coal linkage",
        "gas allocation power", "gas supply power plant",
        "hydro power delay", "hydroelectric delay", "pump storage",
        "energy storage bottleneck", "battery storage grid",
        "flue gas desulphurisation", "fgd deadline", "emission norms power",
        "power purchase agreement delay", "ppa renegotiation",
        "electricity act amendment", "power sector reform",
        "cross-subsidy surcharge", "open access delay",
        "power exchange", "iex volume", "pxil",
        "stranded power asset", "stressed power asset",
        "power sector npa", "power sector debt",
    ],
    ...
    "INDIA_WATER_INFRA": [
        ...
        # Expanded: river linking, desalination, irrigation
        "river linking project", "interlinking of rivers", "desalination plant",
        "irrigation bottleneck", "canal shortage", "water table",
        "water rationing", "tanker water", "water privatisation",
        "water board crisis", "sewage treatment gap", "water contamination",
        "fluoride contamination", "arsenic contamination water",
        "cauvery water dispute", "krishna water dispute", "narmada water",
        "water allocation dispute", "drought", "water emergency",
    ],
    "INDIA_HOUSING_INFRA": [
    ...
    "INDIA_NUCLEAR_POWER": [
        # India nuclear power capacity and bottleneck
        "india nuclear", "nuclear power india", "nuclear bottleneck india",
        "nuclear capacity india", "nuclear plant india",
        # Without "india" prefix (for Indian news sources)
        "npcil", "nuclear power corporation", "kudankulam",
        "kudankulam delay", "kudankulam unit", "nuclear fuel shortage",
        "nuclear fuel supply", "uranium shortage", "uranium supply india",
        "bhavini", "fast breeder reactor", "kalpakkam",
        "tarapur nuclear", "rawatbhata", "kakrapar", "narora nuclear",
        "jaitapur nuclear", "nuclear commissioning delay",
        "nuclear power plant delay", "nuclear capacity addition",
        "nuclear reactor delay", "nuclear energy bottleneck",
        "nuclear safety concern", "atomic energy", "department of atomic energy",
        "dae nuclear", "nuclear fuel complex", "heavy water plant",
        "nuclear waste", "nuclear regulatory", "aerb nuclear",
        "thorium reactor", "thorium fuel", "pressurized heavy water",
        "phwr", "nuclear liability", "nuclear insurance",
        "small modular reactor india", "smr india",
    ],
    "INDIA_TRANSMISSION_GRID": [
        # Power transmission and grid evacuation — distinct from generation/distribution
        "grid evacuation", "grid evacuation delay", "grid evacuation bottleneck",
        "transmission line delay", "transmission line bottleneck",
        "transmission capacity constraint", "transmission infrastructure gap",
        "pgcil", "power grid corporation", "powergrid transmission",
        "inter-state transmission", "intra-state transmission",
        "ists transmission", "green energy corridor",
        "green energy corridor delay", "green energy corridor bottleneck",
        "substation bottleneck", "substation capacity", "substation delay",
        "765 kv", "400 kv", "hvdc transmission", "hvdc link",
        "transmission tower", "transmission tower delay",
        "right of way transmission", "row delay transmission",
        "power evacuation bottleneck", "power evacuation delay",
        "solar evacuation", "wind evacuation", "renewable evacuation",
        "grid integration bottleneck", "grid modernisation",
        "smart grid india", "grid congestion india",
        "cts transmission", "ctuo", "ctu",
        "transmission planning", "transmission infra delay",
    ],
    "INDIA_SEMICONDUCTOR_MATERIALS": [
        # Semiconductor raw materials and supply chain in India
        "silicon wafer india", "polysilicon india", "polysilicon shortage",
        "semiconductor material shortage", "semiconductor material supply",
        "electronic grade silicon", "chip raw material",
        "rare earth india", "rare earth shortage india",
        "gallium india", "germanium india", "neon gas supply",
        "specialty chemical semiconductor", "specialty gas semiconductor",
        "pcb manufacturing india", "printed circuit board india",
        "eda tools india", "chip design ecosystem",
        "semiconductor equipment india", "fab equipment shortage",
    ],
    "INDIA_BANKING_CREDIT": [
        # Banking and credit bottlenecks
        "credit squeeze", "credit crunch", "liquidity crunch",
        "liquidity shortage", "liquidity deficit", "banking liquidity",
        "nbfc liquidity", "nbfc crisis", "nbfc stress",
        "npa crisis", "npa bottleneck", "bad loan surge",
        "credit growth slowdown", "bank lending constraint",
        "deposit growth", "credit deposit ratio", "cd ratio",
        "repo rate impact lending", "monetary policy transmission",
        "banking capital adequacy", "capital infusion psu bank",
        "msme credit gap", "msme lending constraint",
        "microfinance stress", "microfinance npa",
        "fintech lending constraint", "digital lending regulation",
        "co-lending bottleneck", "priority sector lending",
        "yes bank crisis", "banking fraud", "banking sector stress",
        "rbi pca framework", "prompt corrective action bank",
    ],
    "INDIA_AGRI_SUPPLY": [
        # Agricultural supply chain and food security
        "crop shortage", "crop damage", "crop failure",
        "food inflation surge", "food price surge", "onion shortage",
        "tomato shortage", "wheat shortage", "rice shortage",
        "sugar shortage", "sugar export ban", "pulse shortage",
        "edible oil shortage", "mustard oil price",
        "fertilizer shortage", "fertiliser shortage", "urea shortage",
        "dap shortage", "fertilizer subsidy delay",
        "mandi bottleneck", "apmc bottleneck", "cold storage shortage",
        "food supply chain disruption", "harvest delay",
        "monsoon deficit", "monsoon delay", "kharif sowing delay",
        "rabi sowing", "crop insurance delay", "pm fasal bima",
        "agricultural labour shortage", "farm labour crisis",
        "minimum support price", "msp crisis", "procurement delay",
        "fci storage shortage", "godown shortage",
    ],
    "INDIA_DEFENCE_AERO": [
        # Defence and aerospace manufacturing bottlenecks
        "hal delivery delay", "hal production bottleneck",
        "defence production delay", "defence procurement delay",
        "tejas delivery delay", "tejas production",
        "drdo project delay", "defence offset obligation",
        "ammunition shortage", "ammunition supply",
        "bhel defence", "bel order delay",
        "defence import dependency", "defence indigenisation",
        "defence corridor", "defence manufacturing",
        "naval vessel delay", "submarine delay",
        "helicopter delivery delay", "missile production",
        "defence export constraint", "dpsu delay",
        "defence budget constraint", "capital expenditure defence",
    ],
    "INDIA_PHARMA_HEALTH": [
        # Pharma and healthcare infrastructure bottlenecks
        "api shortage", "active pharmaceutical ingredient shortage",
        "bulk drug shortage", "drug shortage", "medicine shortage",
        "pharma supply chain constraint", "pharma raw material shortage",
        "hospital bed shortage", "healthcare infrastructure gap",
        "medical equipment shortage", "medical device shortage",
        "clinical trial bottleneck", "drug approval delay",
        "who gmp compliance", "pharma quality issue",
        "pli pharma", "pharma manufacturing constraint",
        "vaccine production bottleneck", "vaccine supply constraint",
        "oxygen supply shortage", "medical oxygen",
    ],
}
...
def _detect_bottleneck(title: str, description: str, region: str = "") -> list[str]:
    ...
    if is_india_context:
        _REGEX_PATTERNS.extend([
            ...
            (r'(ntpc|thermal).*plant.*(delay|shut|breakdown)', "INDIA_POWER_GRID"),
            (r'coal.*import.*(surge|increase|record)', "INDIA_POWER_GRID"),
            (r'electricity.*demand.*(record|all.time|peak|surge)', "INDIA_POWER_GRID"),
            ...
            (r'(water|river).*dispute.*(supreme court|tribunal)', "INDIA_WATER_INFRA"),
            (r'drought.*(district|state|region|farmer)', "INDIA_WATER_INFRA"),
            (r'(cement|steel|sand).*shortage', "INDIA_HOUSING_INFRA"),
            (r'construction.*labour.*shortage', "INDIA_HOUSING_INFRA"),
            # Nuclear power
            (r'(npcil|nuclear power).*commissioning', "INDIA_NUCLEAR_POWER"),
            (r'(nuclear|atomic).*reactor.*(delay|commission|critical)', "INDIA_NUCLEAR_POWER"),
            (r'kudankulam.*unit.*(delay|commission|critical)', "INDIA_NUCLEAR_POWER"),
            (r'uranium.*(shortage|supply|import|fuel)', "INDIA_NUCLEAR_POWER"),
            (r'nuclear.*capacity.*(addition|expansion|target)', "INDIA_NUCLEAR_POWER"),
            (r'(dae|dept.*atomic).*budget', "INDIA_NUCLEAR_POWER"),
            # Transmission / Grid evacuation
            (r'(pgcil|power\s*grid).*transmission.*(delay|bottleneck|constraint)', "INDIA_TRANSMISSION_GRID"),
            (r'(solar|wind|renewable).*evacuation.*(delay|bottleneck|constraint)', "INDIA_TRANSMISSION_GRID"),
            (r'(765|400|220)\s*kv.*(line|substation).*(delay|commission)', "INDIA_TRANSMISSION_GRID"),
            (r'green.*energy.*corridor.*(delay|phase|bottleneck)', "INDIA_TRANSMISSION_GRID"),
            (r'grid.*evacuation.*(bottleneck|delay|shortage|constraint)', "INDIA_TRANSMISSION_GRID"),
            (r'transmission.*line.*(delay|right.*way|row)', "INDIA_TRANSMISSION_GRID"),
        ])
